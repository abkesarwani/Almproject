...
public class ClientDaoImpl implements ClientDao
{
    	...
    	boolean rs=false;
    	 ...
    	 catch (Exception e)
    	 {
    		// entitymanager.getTransaction().rollback();
    		 // System.out.println("Client Not Created due to duplicate key");
    	 }
    	 return rs;
	...
	public ClientDomain searchClient(String clName) {
	     ...
	     EntityManager entitymanager = emfactory.createEntityManager( );
		 	entitymanager.getTransaction().begin( );
    	Client obj=entitymanager.find(Client.class,clName);
    ...
    Query query = entitymanager.
		      ...
		      ClientDomain cObj=new ClientDomain(obj.getC_name(), obj.getC_address(), result[0], result[1], result[2], obj.getC_desc(), obj.getC_revenue(), obj.getC_employees(), obj.getC_presence(), obj.getC_ceo(), obj.getC_cto(), pocresult[0], pocresult[1], obj.getC_status());
		      entitymanager.getTransaction().commit();
    	entitymanager.close( );
	      emfactory.close( );
    	System.out.println(obj.toString());
