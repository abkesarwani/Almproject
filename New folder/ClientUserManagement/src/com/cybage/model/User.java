...
public User(String u_name, String gender, String u_status, String u_role,
		String u_group, String u_contact) {
	super();
	this.u_name = u_name;
	this.gender = gender;
...
public String toString() {
	return "User [u_name=" + u_name + ", gender=" + gender + ", u_status="
			+ u_status + ", u_role=" + u_role + ", u_group=" + u_group
			+ ", u_contact=" + u_contact + "]";
}
